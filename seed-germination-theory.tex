...
\usepackage{tocloft} % fix narrow section numbering in ToC
...
\include{ch-design} % 3
\include{ch-rates} %4
\include{ch-inhibit-dry} % 5
\include{ch-inhibit-moist} % 6
\include{ch-inhibit-two} % 7
\include{ch-fruit} % 8
\include{ch-physical} % 9
\include{ch-outdoor} % 10
\include{ch-photo} % 11
\include{ch-exo} % 12
\include{ch-dry} % 13
\include{ch-seed} % 14
\include{ch-collect} % 15
\include{ch-nomen}
\include{ch-end} % 17
\include{ch-genera} % 18
\include{ch-rate} % 19
\include{ch-data} % 20
\include{ch-orchid} % 21
\include{ch-grass} % 22
\include{ch-donor} % 23
\include{ch-ref} % 24, 25
